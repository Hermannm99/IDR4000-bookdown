...
```{r, echo = FALSE, warning=FALSE, fig.caption = "Figur 1: Figuren viser sammenhengen mellom antall PCR-sykluser og fluorescence "}
...
```{r cqtabell, warning=FALSE, tab.cap= "Tabellen viser cq-verider"}
