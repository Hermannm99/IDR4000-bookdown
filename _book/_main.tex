...
\section{\texorpdfstring{\textbf{Spørsmål}}{Spørsmål}}\label{spuxf8rsmuxe5l}}
...
\hypertarget{alternativ}{%
\section{\texorpdfstring{\textbf{Alternativ}}{Alternativ}}\label{alternativ}}
...
\hypertarget{logik}{%
\section{\texorpdfstring{\textbf{Logik}}{Logik}}\label{logik}}
...
\hypertarget{metoder}{%
\section{\texorpdfstring{\textbf{Metoder}}{Metoder}}\label{metoder}}
...
\caption{\label{fig:unnamed-chunk-2}Figur 1 viser økningen i muskelvekst fra pre- post for alle forsøkspersoner skildt ved single- sett og multiple- sett}
\end{figure}
