...
Tilhørende repository: \url{https://github.com/Hermannm99/IDR4000-bookdown.git}
...
Deskriptive data for disse deltakerne er vist i Tabell 1.1, i Figur 1 kan man se forskjellen mellom test 1o og 2 fordelt på kjønn. Det typiske målefeilet (typical error, \citep{hopkins2000}) fra test 1 til test 2 er utregnet til å være 4.04\%.
...
\hypertarget{labrapport---rna}{%
\chapter{Labrapport - RNA}\label{labrapport---rna}}
...
\caption{\label{fig:unnamed-chunk-5}Efficiency kalkulasjoner basert på fortyningsserie av cDNA}
\end{figure}
...
I alle studiene besvares hypotesen, men det presiseres også at det trengs mer forskning på området for å kunne konkludere. Det gis også forklaringer på betydningen av metodiske svakheter i studiene som for eksempel små utvalg, og kort varighet som kan gi mindre utslag . Disse studiene viser også at den metodiske utformingen er viktig da frekvensens påvirkning kan gi signifikant p-verdi i en type studie, med lavere frekvenser som sammenliknes, men ikke i andre. Derfor er også konklusjonene litt forskjellige, og gjelder kun for frekvensene som sammenliknes, og ikke treningsfrekvens generelt. Disse studiene er med på å bidra til den totale evidensen rundt frekvenses påvirkning på treningsadabtasjoner\citep{johnsen2021, brigatto2019, gentil2018, saric2019, lasevicius2019}. Disse studiene baserer sin konklusjon på tidligere litteratur diskutert i diskusjonsdeler, og gjør en slutning på årask-virkning forholdet som hensyntar både funnet i studien, men også satt opp mot evidensen fra diskusjonsdelen.

\hypertarget{treningsvolum-artikkel}{%
\chapter{Treningsvolum artikkel}\label{treningsvolum-artikkel}}

\hypertarget{huxf8yere-treningsvolum-leder-til-bedre-styke-men-lik-muskelvekst-i-underekstremiteter-hos-utrente}{%
\section{Høyere treningsvolum leder til bedre styke, men lik muskelvekst i underekstremiteter hos utrente}\label{huxf8yere-treningsvolum-leder-til-bedre-styke-men-lik-muskelvekst-i-underekstremiteter-hos-utrente}}
